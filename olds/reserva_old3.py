...
"border-bottom-color:rgba(146,82,101,255);")
        ...
        self.txt_consulta_reserva.setStyleSheet("\n"
...
"")
        ...
        self.btn_pesquisarRsv.setStyleSheet("QPushButton#btn_pesquisarNoti{\n"
...
"}")
        ...
        self.btn_novaRsv.setStyleSheet("QPushButton#btn_notifica{\n"
"    background-color: qlineargradient(spread:pad, x1:0, y1:0.505682, x2:1, y2:0.477, stop:0 rgba(11, 131, 120, 219), stop:1 rgba(85, 98, 112, 226));\n"
"    color:rgba(255, 255, 255, 210);\n"
"    border-radius: 5px;\n"
"}\n"
...
"}")
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(160, 300, 242, 34))
...
"")
        ...
        self.btn_alterarR.setGeometry(QtCore.QRect(510, 300, 117, 32))
...
"    background-color: qlineargradient(spread:pad, x1:0, y1:0.505682, x2:1, y2:0.477, stop:0 rgba(169, 169, 169, 0), stop:1 rgba(85, 98, 112, 226));\n"
"    color:rgba(255, 0, 0, 210);\n"
"    border-radius: 5px;\n"
"}\n"
...
"")
        ...
        self.txt_id_reserva.setStyleSheet("\n"
"border:2px solid rgba(0,0,0,0);\n"
"border-bottom-color:rgba(46,82,101,255);\n"
"color:rgb(0,0,0);\n"
"padding-bottom:7px\n"
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_agendar.clicked.connect(self.alterarReserva)
    ...
    def pesquisar(self):             
        reserva = self.lineEdit_4.text()  
        banco = sqlite3.connect('bd/Reserva_treinamento.db') 
        cursor.execute( "SELECT * FROM reserva WHERE reserva_n like '%"+str(reserva)+"%' ORDER BY data_solicitacao DESC" )
        resul = banco.execute(sql)        
        self.tableWidget.setRowCount(0)
        print(resul)
    ...
    def alterarReserva(self):
        ...
        banco = sqlite3.connect('bd/Reserva_treinamento.db') 
        cursor = banco.cursor()
        sql = ("UPDATE Reserva SET Setor= '{}', solicitante = '{}', data_solicitacao = '{}', data_agenda= '{}', chamado='{}', hr_inicio = '{}', hr_fim='{}',Estatus= '{}', obs='{}' WHERE  reserva_n ='{}'".format(setor,solicitante,data_solicitacao,data_agenda,chamado,hr_inicio,hr_fim,Estatus,obs ,n_reserva_n))
        # sql=("UPDATE reserva SET setor ='{}', solicitante ='{}',data_solicitacao ='{}',data_agenda ='{}',chamado ='{}',hr_inicio ='{}',hr_fim ='{}' WHERE reserva_n = '{}'".format(setor,solicitante,data_solicitacao,data_agenda,hr_inicio,hr_fim,n_reserva_n))
        resul = banco.execute(sql)
