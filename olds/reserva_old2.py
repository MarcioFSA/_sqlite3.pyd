...
"}")
        ...
        self.btn_agendar.setStyleSheet("QPushButton#btn_novaRsv{\n"
"    background-color: qlineargradient(spread:pad, x1:0, y1:0.505682, x2:1, y2:0.477, stop:0 rgba(11, 131, 120, 219), stop:1 rgba(85, 98, 112, 226));\n"
"    color:rgba(255, 255, 255, 210);\n"
"    border-radius: 5px;\n"
"}\n"
...
"}")
        ...
        self.btn_cancelar.setStyleSheet("QPushButton#btn_novaRsv{\n"
"    background-color: qlineargradient(spread:pad, x1:0, y1:0.505682, x2:1, y2:0.477, stop:0 rgba(11, 131, 120, 219), stop:1 rgba(85, 98, 112, 226));\n"
"    color:rgba(255, 255, 255, 210);\n"
"    border-radius: 5px;\n"
"}\n"
...
"border-bottom-color:rgba(146,82,101,255);")
        ...
        self.btn_reservas.setStyleSheet("QPushButton#btn_novaRsv{\n"
"    background-color: qlineargradient(spread:pad, x1:0, y1:0.505682, x2:1, y2:0.477, stop:0 rgba(11, 131, 120, 219), stop:1 rgba(85, 98, 112, 226));\n"
"    color:rgba(255, 255, 255, 210);\n"
"    border-radius: 5px;\n"
"}\n"
...
"")
    ...
    def editarReserva(self):
        reserva = self.txt_consulta_reserva.text()
        banco = sqlite3.connect('bd/Reserva_treinamento.db') 
        sql=( "SELECT * FROM reserva WHERE reserva_n like '%"+str(reserva)+"%'")
    ...
    def pesquisar(self):             
        ...
        banco = sqlite3.connect('bd/Reserva_treinamento.db') 
        sql=( "SELECT * FROM reserva WHERE reserva_n like '%"+str(reserva)+"%' ORDER BY data_solicitacao DESC" )
        resul = banco.execute(sql)        
        self.tableWidget.setRowCount(0)
        print(resul)
    ...
    def alterarReserva(self):
        ...
        Estatus=self.comboBox_2.currentText()
        obs = self.txt_obs.text() 
        n_reserva = self.lineEdit_4.text()           
        banco = sqlite3.connect('bd/Reserva_treinamento.db') 
        sql = ("UPDATE reserva SET setor = '{}' WHERE setor ='{}'".format(setor, n_reserva))
        # sql=("UPDATE reserva SET setor ='{}', solicitante ='{}',data_solicitacao ='{}',data_agenda ='{}',\
                # chamado ='{}',hr_inicio ='{}',hr_fim ='{}',Estatus ='{}',obs ='{}'WHERE reserva_n = '{}'".format(setor,solicitante,data_solicitacao,data_agenda,hr_inicio,hr_fim,Estatus,obs, reserva_n))
        resul = banco.execute(sql)
        cd_reserva = setor
        print(sql)
        # if resul:                
